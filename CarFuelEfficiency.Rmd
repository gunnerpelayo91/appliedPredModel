...
As an aside, is ther a difference between average fuel efficiencies of 2010 and 2012?
...
```{r}
testTranny = filter(cars2010a, Transmission %in% c('AV','AM7','AM6'))
